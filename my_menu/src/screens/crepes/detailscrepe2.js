...
import cheesegrater2 from "../../images/crepe/2/cheese-grater.png";
import friedegg from "../../images/crepe/2/fried-egg.png";
import spinach from "../../images/crepe/2/spinach.png";
      ...
      <View style={{ backgroundColor: "#FFF" }}>
        <ScrollView>
          ...
          >
            ...
            >
              <Image source={bacon} style={{ height: 30, width: 30 }} />
            </View>
            ...
            >
              <Image source={cheesegrater2} style={{ height: 30, width: 30 }} />
            </View>
            <View
              style={{
                borderRadius: 15,
            ...
            >
              <Image source={friedegg} style={{ height: 30, width: 30 }} />
            </View>
            ...
            >
              <Image source={spinach} style={{ height: 30, width: 30 }} />
            </View>
