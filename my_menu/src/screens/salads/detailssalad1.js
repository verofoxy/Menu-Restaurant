...
import boiledegg from "../../images/salad/1/boiled-egg.png";
import lettuce from "../../images/salad/1/lettuce.png";
import chicken from "../../images/salad/1/chicken-leg.png";
import tomato from "../../images/salad/1/tomato.png";
      ...
      <View style={{ backgroundColor: "#FFF" }}>
        <ScrollView>
          ...
          >
            ...
            >
              <Image source={chicken} style={{ height: 30, width: 30 }} />
            </View>
            ...
            >
              <Image source={boiledegg} style={{ height: 30, width: 30 }} />
            </View>
            <View
              style={{
                borderRadius: 15,
            ...
            >
              <Image source={lettuce} style={{ height: 30, width: 30 }} />
            </View>
            ...
            >
              <Image source={tomato} style={{ height: 30, width: 30 }} />
            </View>
